    ...
    <main>
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <div className="fixed bottom-[13%] right-[3%] z-10 border rounded-full w-12 h-12 flex justify-center items-center bg-slate-200 cursor-pointer">
            <FaShare
          ...
          {copied && (
            <p className="fixed bottom-[14%] right-[7%] z-10 rounded-md bg-slate-100 p-2">
              Link copied!
            </p>
          )}
